	...
	$(document).ready( function () {
    	...
    	$("#compList tbody .delBtn").click(function(){
            if(confirm("是否确认删除？")){
                ...
                $.post("<?php echo U('Manage/delCompIn');?>",{id:id},function(data){
...
<div id="toolBarMenu">
	<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addDataModal">新增入库</button>
	...
	<!-- 模态框（Modal） -->
	<form class="form-horizontal" role="form" id="compAddInForm" method="post" action="<?php echo U('Manage/addCompIn');?>">
		    ...
		    <div class="modal-dialog" style="width:90%">
		        <div class="modal-content">
		            <div class="modal-header">
		                ...
		                <h4 class="modal-title" id="addDataModalLable">新增入库</h4>
		            </div>
						    ...
						    <div class="form-group">
						      ...
						      <div class="col-sm-8">
						   		 <input type="text" class="form-control store_num" name="store_num"
						               placeholder="库存数量" readonly="readonly">
						      </div>

						   </div>

						   <div class="form-group">
						      <label for="store_num" class="col-sm-2 control-label">入库数量</label>
						      <div class="col-sm-8">
						         <input type="text" class="form-control inNum" name="inNum" placeholder="请输入入库数量" >
						      </div>
						    </div>
						    <div class="form-group">
...
<table id="compList" class="bordered research">
    ...
    <tbody>
    	<?php if(is_array($data)): $k = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
            	<td><?php echo ($k); ?></td>
            	<td data-type="$vo.compReserve.type">
...
<script type="text/javascript">
	...
	$("#addDataModal .compType").change(function(){
